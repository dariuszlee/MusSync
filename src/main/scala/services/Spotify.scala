...
object SpotifyUtility {
  ...
  val fullUri = "https://accounts.spotify.com/en/authorize?client_id=40b76927fb1a4841b2114bcda79e829a&response_type=code&redirect_uri=http:%2F%2Flocalhost:8080/callback&scope=user-follow-read%20&state=34fFs29kd09&show_dialog=true"
